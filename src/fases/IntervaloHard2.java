 ...
 * @author kamila_brito
 */
public class IntervaloHard2 implements GameStateController{
    
    private Imagem bgImageHard2;
    ...
    public void load() {
         ...
         try {
            ...
            this.bgImageHard2 = new Imagem("img_cenario/Intervalos/hard2.png");
    ...
    public void step(long timeElapsed) {
        ...
        if (Utilidades.estaClicandoEm(650, 520, 89, 75)) {
            GameEngine.getInstance().setNextGameStateController(13);
        }
