 ...
 * @author kamila_brito
 */
public class IntervaloMedium1 implements GameStateController{
    private Imagem bgImageMedium1;
    ...
    public void load() {
         ...
         try {
            ...
            this.bgImageMedium1 = new Imagem("img_cenario/Intervalos/medium1.png");
    ...
    public void draw(Graphics g) {
        ...
        this.bgImageMedium1.draw(g, 0, 0);
