 ...
 * @author kamila_brito
 */
public class IntervaloHard3 implements GameStateController{
    
    private Imagem bgImageHard3;
    ...
    public void load() {
         ...
         try {
            ...
            this.bgImageHard3 = new Imagem("img_cenario/Intervalos/hard3.png");
